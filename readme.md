...
- **Secure Authentication:**
  - Login, signup, password reset, and logout.
...
# Email credentials for sending password resets
...
- **Please Note**: While the demo account provides a convenient way to explore many features, it has some limitations:
    - **Password Reset**: Due to security reasons, the demo account uses a non-real email address. Therefore, password reset functionality is not available for this account.

    **What this means**:
    - You cannot request a password reset on the demo email address.
    - To test password reset flows, you need to create a genuine account with a valid email address.
    ...
    **What to do?**
    ...
    - To test password reset, create a personal account with a valid email address.
