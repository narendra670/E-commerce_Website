...
import {clearLoginError, loginAsync, selectLoginError, selectLoginStatus, selectLoggedInUser} from '../AuthSlice'
...
export const Login = () => {
  ...
  useEffect(()=>{
    if(loginStatus==='fullfilled' && loggedInUser){
      toast.success(`Login successful`)
      navigate("/")
    }
    if(loginStatus==='rejected' && loginError){
      toast.error(loginError?.message || "Login failed")
      dispatch(clearLoginError())
    }
  },[loginStatus, loginError, loggedInUser, navigate, dispatch])
